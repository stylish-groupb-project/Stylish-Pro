      ...
      if (data && selectedVariant && count > 0) {
        ...
        const checkCurrentItem = currentCartItems.findIndex(
          (item) =>
            ...
            item.color.colorName === productCartData.color.colorName &&
            item.color.colorCode === productCartData.color.colorCode &&
            item.size === productCartData.size
        );
        if (checkCurrentItem !== -1) {
          currentCartItems[checkCurrentItem].quantity +=
